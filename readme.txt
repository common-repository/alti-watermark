...
Tags: watermark, medias, photography, dynamic watermark, picture, copyright, photos, logo, upload, signature, images, uploads, media, marca de agua, filigrane, tatouage numerique
...
This plugin adds a watermark dynamically on all your images, even the ones already uploaded.
...
For support, please visit [alti-Watermark plugin](http://www.alticreation.com/en/alti-watermark/ "Watermark Plugin for Wordpress")
...
= 0.3.4 =
* Add medium_large size to admin page.
